...
def make_model(class_weight="balanced") -> Pipeline:
    return Pipeline(
        [
...
def train_variant(
    ...
    base_model = make_model(class_weight="balanced")
...
def train():
    ...
    no_odds_unweighted_model = make_model(class_weight=None)
    no_odds_unweighted_model.fit(train_df[no_odds_columns], train_df.target)
    no_odds_unweighted_metrics = evaluate(
        test_df.target,
        no_odds_unweighted_model.predict_proba(test_df[no_odds_columns]),
    )
    ...
    joblib.dump(
        no_odds_unweighted_model,
        MODEL_DIR / "lightgbm_no_odds_unweighted.joblib",
    )
    ...
    metadata = {
        ...
        "comparison": {
            ...
            "no_odds_unweighted": {
                "selected_kind": "uncalibrated_unweighted",
                "selected": no_odds_unweighted_metrics,
            },
        },
    }
    ...
    print("Comparison model: lightgbm_no_odds_unweighted.joblib")
